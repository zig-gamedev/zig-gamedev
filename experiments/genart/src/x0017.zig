...
pub const name = "generative art experiment: x0017";
...
pub fn draw() void {
    ...
    const xyoff = 0.05 * (-1.0 + 2.0 * random.float(f32));

    gl.loadIdentity();
    gl.scalef(1.0 + xyoff, 1.0 + xyoff, 1.0);
    gl.rotatef(5.0 * (-1.0 + 2.0 * random.float(f32)), 0, 0, 1);
