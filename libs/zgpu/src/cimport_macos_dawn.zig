...
pub extern fn dawnProcSetProcs(procs: [*c]const DawnProcTable) void;
pub const struct_DawnNativeInstanceImpl = opaque {};
pub const DawnNativeInstance = ?*struct_DawnNativeInstanceImpl;
...
pub extern fn dawnNativeGetWgpuInstance(native_instance: DawnNativeInstance) WGPUInstance;
pub extern fn dawnNativeDiscoverDefaultAdapters(native_instance: DawnNativeInstance) void;
pub extern fn dawnNativeGetProcs() [*c]const DawnProcTable;
...
pub const INCLUDE_DAWN_DAWN_PROC_H_ = "";
...
pub const DawnNativeInstanceImpl = struct_DawnNativeInstanceImpl;
