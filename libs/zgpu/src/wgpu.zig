...
pub const Limits = extern struct {
    ...
    max_uniform_buffer_binding_size: u64 = 64 * 1024,
    max_storage_buffer_binding_size: u64 = 128 * 1024 * 1024,
    min_uniform_buffer_offset_alignment: u32 = 256,
    min_storage_buffer_offset_alignment: u32 = 256,
    max_vertex_buffers: u32 = 8,
    max_buffer_size: u64 = 256 * 1024 * 1024,
    max_vertex_attributes: u32 = 16,
    max_vertex_buffer_array_stride: u32 = 2048,
    max_inter_stage_shader_components: u32 = 60, // NOTE: WebGPU spec calls for a minimum of 64, however in practice it seems to be 60?
    max_inter_stage_shader_variables: u32 = 16,
    max_color_attachments: u32 = 8,
    max_color_attachment_bytes_per_sample: u32 = 32,
    max_compute_workgroup_storage_size: u32 = 16 * 1024,
