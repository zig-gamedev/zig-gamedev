...
// JPH_ShapeSettings
//
JPH_CAPI JPH_Shape *    JPH_ShapeSettings_Cook(const JPH_ShapeSettings *inSettings);
JPH_CAPI uint64         JPH_ShapeSettings_GetUserData(const JPH_ShapeSettings *inSettings);
JPH_CAPI void           JPH_ShapeSettings_SetUserData(JPH_ShapeSettings *inSettings, uint64 inUserData);
...
JPH_CAPI void                           JPH_ConvexShapeSettings_SetDensity(
                                            JPH_ConvexShapeSettings *inSettings,
                                            float inDensity
                                        );
//
...
JPH_CAPI void                   JPH_BoxShapeSettings_SetHalfExtent(
