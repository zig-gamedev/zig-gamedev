...
void* (*zmeshMallocPtr)(size_t size) = NULL;
void* (*zmeshCallocPtr)(size_t num, size_t size) = NULL;
void* (*zmeshReallocPtr)(void* ptr, size_t size) = NULL;
void (*zmeshFreePtr)(void* ptr) = NULL;
