...
* Zero dependency except [Zig compiler](https://ziglang.org/download/) (repository content is fully standalone and can be build on any machine - no Visual Studio/Build Tools/Windows SDK needed)
