**Project requires [Zig 0.10.0-dev.2412 (master)](https://ziglang.org/download/) or newer to compile. On MacOS you have to use `-Dzgpu-dawn-from-source=true` (this will be fixed shortly).**
# zig-gamedev project
