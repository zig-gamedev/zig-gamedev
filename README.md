NOTE: To compile this project you need latest version of Zig compiler (zig-windows-x86_64-0.9.0-dev.1903+ or newer). Download it [here](https://ziglang.org/download/).
