...
* [zmesh](https://github.com/michal-z/zig-gamedev/blob/main/libs/zmesh) - Zig bindings for [par_shapes](https://github.com/prideout/par/blob/master/par_shapes.h) (**cross-platform**)
