...
pub fn build(b: *std.build.Builder) void {
    ...
    dxc_command = makeDxcCmd("src/mesh_shader_test.hlsl", "msMain", "mesh_shader.ms.cso", "ms", "PSO__MESH_SHADER");
    dxc_step.dependOn(&b.addSystemCommand(&dxc_command).step);
    ...
    dxc_command = makeDxcCmd("src/mesh_shader_test.hlsl", "vsMain", "vertex_shader_fixed.vs.cso", "vs", "PSO__VERTEX_SHADER_FIXED");
    dxc_step.dependOn(&b.addSystemCommand(&dxc_command).step);
    dxc_command = makeDxcCmd("src/mesh_shader_test.hlsl", "psMain", "vertex_shader_fixed.ps.cso", "ps", "PSO__VERTEX_SHADER_FIXED");
    dxc_step.dependOn(&b.addSystemCommand(&dxc_command).step);
