...
pub fn build(b: *std.build.Builder) void {
    ...
    dxc_command = makeDxcCmd("src/bullet_physics_test.hlsl", "vsDrawTexture", "draw_texture.vs.cso", "vs", "PSO__DRAW_TEXTURE");
    dxc_step.dependOn(&b.addSystemCommand(&dxc_command).step);
    dxc_command = makeDxcCmd("src/bullet_physics_test.hlsl", "psDrawTexture", "draw_texture.ps.cso", "ps", "PSO__DRAW_TEXTURE");
    dxc_step.dependOn(&b.addSystemCommand(&dxc_command).step);

    dxc_command = makeDxcCmd("src/bullet_physics_test.hlsl", "csTextureToBuffer", "texture_to_buffer.cs.cso", "cs", "PSO__TEXTURE_TO_BUFFER");
    dxc_step.dependOn(&b.addSystemCommand(&dxc_command).step);

    dxc_command = makeDxcCmd("src/bullet_physics_test.hlsl", "csBufferToTexture", "buffer_to_texture.cs.cso", "cs", "PSO__BUFFER_TO_TEXTURE");
    dxc_step.dependOn(&b.addSystemCommand(&dxc_command).step);
