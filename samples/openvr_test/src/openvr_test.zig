...
const InputWindow = struct {
    ...
    set_action_manifest_path_result: ?OpenVR.Input.InputError!void = null,
    ...
    update_action_state_sets: std.ArrayList(OpenVR.Input.ActiveActionSet),
    update_action_state_result: ?OpenVR.Input.InputError!void = null,

    digital_action_data_action: OpenVR.Input.ActionHandle = 0,
    digital_action_data_restrict_to_device: OpenVR.InputValueHandle = 0,
    analog_action_data_action: OpenVR.Input.ActionHandle = 0,
    analog_action_data_restrict_to_device: OpenVR.InputValueHandle = 0,
    pose_action_data_relative_to_now_action: OpenVR.Input.ActionHandle = 0,
    ...
    pose_action_data_for_next_frame_action: OpenVR.Input.ActionHandle = 0,
    ...
    skeletal_action_data_action: OpenVR.Input.ActionHandle = 0,
    set_dominant_hand: OpenVR.TrackedControllerRole = .invalid,
    set_dominant_hand_result: ?OpenVR.Input.InputError!void = null,
    bone_count_action: OpenVR.Input.ActionHandle = 0,

    bone_name_action: OpenVR.Input.ActionHandle = 0,
    bone_name_bone_index: OpenVR.Input.BoneIndex = 0,

    skeletal_reference_transforms_action: OpenVR.Input.ActionHandle = 0,
    skeletal_reference_transforms_transform_space: OpenVR.Input.SkeletalTransformSpace = .model,
    skeletal_reference_transforms_reference_pose: OpenVR.Input.SkeletalReferencePose = .bind_pose,
    skeletal_reference_transforms_transform_count: usize = 0,
    skeletal_tracking_level_action: OpenVR.Input.ActionHandle = 0,
    skeletal_bone_data_action: OpenVR.Input.ActionHandle = 0,
    skeletal_bone_data_transform_space: OpenVR.Input.SkeletalTransformSpace = .model,
    skeletal_bone_data_motion_range: OpenVR.Input.SkeletalMotionRange = .with_controller,
    skeletal_bone_data_transform_count: usize = 0,
    skeletal_summary_data_action: OpenVR.Input.ActionHandle = 0,
    skeletal_summary_data_summary_type: OpenVR.Input.SummaryType = .from_animation,
    skeletal_bone_data_compressed_action: OpenVR.Input.ActionHandle = 0,
    skeletal_bone_data_compressed_motion_range: OpenVR.Input.SkeletalMotionRange = .with_controller,

    trigger_haptic_vibration_action: OpenVR.Input.ActionHandle = 0,
    ...
    trigger_haptic_vibration_action_result: ?OpenVR.Input.InputError!void = null,

    action_origins_action_set_handle: OpenVR.Input.ActionSetHandle = 0,
    action_origins_digital_action_handle: OpenVR.Input.ActionHandle = 0,
    ...
    action_binding_info_action: OpenVR.Input.ActionHandle = 0,
    action_binding_info_count: u32 = 0,
    show_action_origins_action_set_handle: OpenVR.Input.ActionSetHandle = 0,
    show_action_origins_result: ?OpenVR.Input.InputError!void = null,

    show_action_origins_action_handle: OpenVR.Input.ActionHandle = 0,
    show_bindings_for_action_set_sets: std.ArrayList(OpenVR.Input.ActiveActionSet),
    show_bindings_for_action_set_origin_to_highlight: OpenVR.InputValueHandle = 0,
    show_bindings_for_action_set_result: ?OpenVR.Input.InputError!void = null,
    ...
    open_binding_ui_result: ?OpenVR.Input.InputError!void = null,
    ...
    pub fn init(allocator: std.mem.Allocator) InputWindow {
        return .{
            .update_action_state_sets = std.ArrayList(OpenVR.Input.ActiveActionSet).init(allocator),
            .show_bindings_for_action_set_sets = std.ArrayList(OpenVR.Input.ActiveActionSet).init(allocator),
            .component_state_for_binding_origin_info = std.ArrayList(OpenVR.Input.InputBindingInfo).init(allocator),
        };
    }
